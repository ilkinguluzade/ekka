/**
    ...
    Version: 3.2
    Copyright 2021
	Author URI: https://themeforest.net/user/Ilkin Guluzade
**/
...
function ecCheckCookie() {
  ...
  if (darkMode != "") {
    ...
    if (themeColor != "") {
      ...
      if (themeColor != "01") {
        $("link[href='assets/demo-3/css/responsive.css']").before(
          '<link rel="stylesheet" href="assets/demo-3/css/skin-' + themeColor + '.css" rel="stylesheet">'
        );
      }
    }
  }
...
(function ($) {
  ...
  $("body").on("click", ".add-to-cart", function () {
    ...
    var p_html =
      "<li>" +
      '<a href="product.html" class="sidecart_pro_img"><img src="' +
      img_url +
      '" alt="product"></a>' +
      '<div class="ec-pro-content">' +
      '<a href="product.html" class="cart_pro_title">' +
      p_name +
      "</a>" +
  ...
  $(".ec-change-color").on("click", "li", function () {
    ...
    if (dataValue != undefined) {
      $("link[href='assets/demo-3/css/responsive.css']").before(
        '<link rel="stylesheet" href="assets/demo-3/css/skin-' + dataValue + '.css" rel="stylesheet">'
      );
  ...
  $(document).ready(function () {
    ...
    setTimeout(function () {
      $("#ec-testimonial-slider .slick-prev").prepend(
        '<div class="prev-slick-arrow arrow-icon"><span>&#60;</span></div><div class="prev-slick-img slick-thumb-nav"><img src="/prev.jpg" class="img-responsive"></div>'
      );
      $("#ec-testimonial-slider .slick-next").append(
        '<div class="next-slick-arrow arrow-icon"><span>&#62;</span></div><div class="next-slick-img slick-thumb-nav"><img src="/next.jpg" class="img-responsive"></div>'
      );
      get_prev_slick_img();
      get_next_slick_img();
    ...
    function get_next_slick_img() {
      ...
      // For prev img
      var next_prev_slick_img = $("#ec-testimonial-slider .slick-current")
        .prev("")
        .find(".ec-test-img img")
        .attr("src");
