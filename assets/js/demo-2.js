...
function ecCheckCookie() {
  ...
  if (darkMode != "") {
    ...
    if (themeColor != "") {
      ...
      if (themeColor != "01") {
        $("link[href='assets/demo-2/css/responsive.css']").before(
          '<link rel="stylesheet" href="assets/demo-2/css/skin-' + themeColor + '.css" rel="stylesheet">'
        );
      }
    }
  }
...
(function ($) {
  ...
  $(".ec-change-color").on("click", "li", function () {
    ...
    if (dataValue != undefined) {
      $("link[href='assets/demo-2/css/responsive.css']").before(
        '<link rel="stylesheet" href="assets/demo-2/css/skin-' + dataValue + '.css" rel="stylesheet">'
      );
