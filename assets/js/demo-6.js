...
function ecCheckCookie() {
  ...
  if (darkMode != "") {
    ...
    if (themeColor != "") {
      ...
      if (themeColor != "01") {
        $("link[href='assets/demo-4/css/responsive.css']").before(
          '<link rel="stylesheet" href="assets/demo-4/css/skin-' + themeColor + '.css" rel="stylesheet">'
        );
      }
    }
  }
...
(function ($) {
  ...
  $(".ec-change-color").on("click", "li", function () {
    ...
    if (dataValue != undefined) {
      $("link[href='assets/demo-4/css/responsive.css']").before(
        '<link rel="stylesheet" href="assets/demo-4/css/skin-' + dataValue + '.css" rel="stylesheet">'
      );
  ...
  /*----------------------------- All Product Slider -------------------------------- */
  $(
    ".ec-new-test-product .ec-new-slider, .ec-new-test-product .ec-special-slider,.ec-new-test-product .ec-best-slider"
  ).slick({
    rows: 4,
    dots: false,
    arrows: true,
  ...
  var Animation = function ({ offset } = { offset: 10 }) {
    ...
    var els = (_elements = document.querySelectorAll("[data-animation]:not([data-animated])"));
