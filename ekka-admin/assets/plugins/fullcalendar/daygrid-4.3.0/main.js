  ...
  var DayGridFillRenderer = /** @class */ (function (_super) {
    ...
    DayGridFillRenderer.prototype.renderFillRow = function (type, seg) {
      ...
      skeletonEl = core.htmlToElement(
        '<div class="fc-' + className + '-skeleton">' + "<table><tr></tr></table>" + "</div>"
      );
  ...
  var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderDayRowHtml = function (row, isRigid) {
      ...
      return (
        ...
        "<table>" +
        (this.getIsNumbersVisible() ? "<thead>" + this.renderNumberTrHtml(row) + "</thead>" : "") +
        "</table>" +
        "</div>" +
        "</div>"
      );
    ...
    DayGrid.prototype.renderNumberTrHtml = function (row) {
      ...
      return (
        "" + "<tr>" + (this.isRtl ? "" : intro) + this.renderNumberCellsHtml(row) + (this.isRtl ? intro : "") + "</tr>"
      );
    };
  ...
  var SimpleDayGrid = /** @class */ (function (_super) {
    ...
    SimpleDayGrid.prototype.render = function (props) {
      ...
      dayGrid.receiveProps(
        __assign({}, this.slicer.sliceProps(props, dateProfile, props.nextDayThreshold, dayGrid, dayTable), {
