  ...
  var TimeGridView = /** @class */ (function (_super) {
    ...
    function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
      ...
      if (_this.opt("allDaySlot")) {
        ...
        _this.dayGrid = new daygrid.DayGrid(_this.context, _this.el.querySelector(".fc-day-grid"), { // the all-day subcomponent of this view
  ...
  var SimpleTimeGrid = /** @class */ (function (_super) {
    ...
    SimpleTimeGrid.prototype.render = function (props) {
      ...
      this.timeGrid.receiveProps(
        __assign({}, this.slicer.sliceProps(props, dateProfile, null, this.timeGrid, dayRanges), {
          dateProfile: dateProfile,
